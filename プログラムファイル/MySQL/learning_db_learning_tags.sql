...
CREATE TABLE `learning_tags` (
  ...
  KEY `tag_id` (`tag_id`),
  CONSTRAINT `learning_tags_ibfk_1` FOREIGN KEY (`learning_id`) REFERENCES `learnings` (`id`),
  CONSTRAINT `learning_tags_ibfk_2` FOREIGN KEY (`tag_id`) REFERENCES `tags` (`id`)
...
INSERT INTO `learning_tags` VALUES (39,33,3),(40,33,2),(41,32,11),(42,32,17),(43,34,14),(44,35,11),(45,35,18);
...
-- Dump completed on 2025-09-30 14:06:45
